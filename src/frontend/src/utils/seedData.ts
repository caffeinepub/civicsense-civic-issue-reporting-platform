...
import type { Submission, backendInterface } from "../backend";
...
const sampleIssues: Omit<
  Submission,
  "id" | "createdBy" | "createdAt" | "updatedAt" | "attachments"
>[] = [
  {
  ...
  },
  {
    ...
    description:
      "Construction debris and waste material has been illegally dumped on the roadside near Whitefield main road, blocking part of the lane and creating a hazard.",
    category: Category.waste,
    priority: Priority.high,
    status: Status.inProgress,
    address: {
  ...
  },
  {
    ...
    description:
      "A street light at the main junction of HSR Layout Sector 2 is flickering continuously at night. It is causing discomfort to residents and may indicate an electrical fault.",
    category: Category.streetlights,
  ...
  },
  {
    ...
    description:
      "A large pothole at the base of Electronic City flyover has caused two minor accidents this week. Immediate repair is needed to prevent further incidents.",
    category: Category.potholes,
    priority: Priority.high,
    status: Status.resolved,
    address: {
  ...
  },
  {
    ...
    description:
      "An open manhole without any cover or warning signs has been spotted on Residency Road. This is extremely dangerous for pedestrians and cyclists, especially at night.",
    category: Category.other,
    priority: Priority.high,
    status: Status.inProgress,
  ...
  },
  {
    ...
    description:
      "All street lights in the 3rd Block of Rajajinagar have been non-functional for 10 days. Residents are concerned about safety and have reported increased incidents of theft.",
    category: Category.streetlights,
    priority: Priority.high,
    status: Status.open,
    address: {
  ...
  },
  {
    ...
    description:
      "A blocked storm drain on Church Street is causing severe waterlogging after every rain. The water level rises to knee height and disrupts traffic and pedestrian movement.",
    category: Category.other,
    priority: Priority.medium,
    status: Status.resolved,
  ...
  },
  {
    ...
    description:
      "Sewage is overflowing from a broken pipe near Vijayanagar bus stand. The foul smell and unhygienic conditions are affecting commuters and nearby shop owners.",
    category: Category.waste,
    priority: Priority.high,
    status: Status.open,
    address: {
      street: "Vijayanagar Bus Stand",
      city: "Bangalore",
      zipCode: "560040",
    },
    location: { latitude: 12.9719, longitude: 77.535 },
    assignedStaff: undefined,
  },
  {
    title: "Pothole on Bannerghatta Road near NIMHANS",
    description:
      "A pothole on Bannerghatta Road near NIMHANS junction is causing traffic slowdowns. Vehicles are swerving to avoid it, creating dangerous situations.",
    category: Category.potholes,
    priority: Priority.medium,
    status: Status.open,
    address: {
      street: "Bannerghatta Road, Near NIMHANS",
      city: "Bangalore",
      zipCode: "560029",
    },
    location: { latitude: 12.9399, longitude: 77.595 },
    assignedStaff: undefined,
  },
];
